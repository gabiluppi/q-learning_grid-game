...
from config import CELL_SIZE, GAMMA, ALPHA, EPSILON, EPISODES, MOVE_DELAY, FPS, STEP_PENALTY
...
def setup():
    ...
    pygame.display.set_caption("V2: Single-Agent Q-Learning (With Step Penalty)")
    draw_grid(start_pos)
...
async def update_loop():
    ...
    for episode in range(EPISODES):
        ...
        while grid[agent_state[0]][agent_state[1]] != 'G':
            ...
            reward = rewards[grid[next_state[0]][next_state[1]]] + STEP_PENALTY  # Adiciona penalidade por passo
            row, col = agent_state
